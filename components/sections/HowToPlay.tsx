...
const PLATFORM_LINKS = {
  rockstar: "https://store.rockstargames.com/game/buy-gta-v",
  steam: "https://store.steampowered.com/app/3240220/Grand_Theft_Auto_V/",
...
function PlatformIcon({
  ...
  return (
    <a
      ...
      rel="noreferrer"
      aria-label={label}
      className="platform-icon-button flex h-[72px] w-[72px] shrink-0 items-center justify-center rounded-[20px] border border-transparent focus-visible:outline-none"
    >
      {children}
    </a>
  );
      ...
      <div className="flex flex-1 flex-col gap-3 p-5 2xl:gap-4 2xl:px-[30px] 2xl:py-[30px]">
        ...
        {step.number === "01" && (
          <div className="flex gap-[10px]">
            <PlatformIcon
              href={PLATFORM_LINKS.rockstar}
              label="Купить GTA V в Rockstar Store"
            >
              <RockstarLogo />
            </PlatformIcon>
            <PlatformIcon
              href={PLATFORM_LINKS.steam}
              label="Купить GTA V в Steam"
            >
              <SteamLogo />
            </PlatformIcon>
            <PlatformIcon
              href={PLATFORM_LINKS.epic}
              label="Купить GTA V в Epic Games Store"
            >
              <EpicGamesLogo />
            </PlatformIcon>
          </div>
