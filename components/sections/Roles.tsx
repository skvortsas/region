  ...
  return (
    ...
    >
      ...
      <div className="relative flex-1 overflow-hidden">
        ...
        <div
          aria-hidden="true"
          className="absolute inset-x-0 bottom-0 h-1/2 pointer-events-none bg-gradient-to-t from-[rgba(14,14,15,0.95)] from-[10%] to-transparent"
        />
...
export function Roles() {
  ...
  return (
    ...
    >
      ...
      {openRole && <RolePopup role={openRole} onClose={() => setOpenId(null)} />}
    </section>
  )
}
